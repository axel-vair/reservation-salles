...
<body>
    ...
    <section>
        <form method="post">
            ...
            <input type="text" id="title" name="title" placeholder="votre titre"><br>
            ...
            <textarea id="description" name="description" rows="5" cols="33" placeholder="votre description"></textarea><br>
